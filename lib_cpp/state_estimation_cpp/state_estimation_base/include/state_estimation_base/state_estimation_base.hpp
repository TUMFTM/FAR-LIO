...
public:
   ...
   */
  virtual void set_input_config(const std::vector<std::pair<tam::types::state::measurements::identifier, std::string>>& mapping) = 0;
   ...
   */
  virtual void set_input_external_orientation(
    const tam::types::common::Vector3D<double> & external_orientation) = 0;
   ...
   */
  virtual void set_input_external_orientation_status(const tam::types::ErrorLvl & status) = 0;
   ...
   *                                orientation prior input (0: OK, 1: Warn, 2: Error, 3: STALE)
   */
  virtual void set_input_external_orientation_status(uint8_t status) = 0;
   ...
   */
  virtual tam::pmg::ParamManagerComposer::SharedPtr get_param_handler(void) = 0;
   ...
   */
  virtual void get_state_machine_debug_output(tam::tsl::ValueLogger::SharedPtr logger) = 0;
   ...
   * @param[in]                   - tam::tsl::ValueLogger::SharedPtr
   */
  virtual void get_kalman_filter_debug_output(tam::tsl::ValueLogger::SharedPtr logger) = 0;
};
}  // namespace tam::core::state
