...
std::vector<tam::core::state::types::Point<TConfig>> generate_points(
  const Sophus::SE3f & T = Sophus::SE3f())
{
  // Define a frame of points manually (for deterministic testing of neighbor search)
  tam::core::state::types::Point<TConfig> point_1, point_2, point_3, point_4, point_5, point_6,
    point_7, point_8, point_9, point_10;
